...
@Component({
  selector: 'app-history-upload-cnv-tool-result-list',
  templateUrl: './history-upload-cnv-tool-result-list.component.html',
  styleUrls: ['./history-upload-cnv-tool-result-list.component.scss']
})
export class HistoryUploadCnvToolResultListComponent
  ...
  constructor(
    private _service: HistoryUploadCnvToolResultService,
