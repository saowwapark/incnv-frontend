...
import { isEqual } from '../../../utils/logic.utils';
import { turnListToLowerCase } from '../../../utils/map.utils';
...
export class CustomValidators {
  public static duplicatedFieldInFormArray = (
    ...
    return (formArray: FormArray): { [key: string]: boolean } => {
      const controls: FormControl[] = getControls(
        formArray,
        field
      ) as FormControl[];
  ...
  public static duplicatedInList = (
    ...
    return (control: FormControl): { [key: string]: boolean } => {
      ...
      if (tempVal) {
        const val: string = caseSensitive ? tempVal : tempVal.toLowerCase();
  ...
  public static duplicateInFormGroup(
    formGroup: FormGroup
